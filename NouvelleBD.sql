...
CREATE TABLE Acteurs (
    ActeurId INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
INSERT INTO Categories (CategorieId, Description) VALUES
    (1,'Action'),
    (2,'Adolescent'),
    (3,'Biographie'),
    (4,'Cape et d''épée'),
...
INSERT INTO Formats (FormatId, Description) VALUES
    (1,'Blu-Ray'),
    (2,'Normal'),
    (3,'Panoramique');
...
CREATE TABLE Langues (
    LangueId INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    Langue NVARCHAR(10) NOT NULL
);

SET IDENTITY_INSERT Langues ON
INSERT INTO Langues (LangueId, Langue) VALUES
    (1,'Français'),
    (2,'Anglais'),
    (3,'Espagnol');
...
INSERT INTO Preferences (PreferenceId, Description) VALUES
    (1,'Couleur de fond'),
    (2,'Couleur du texte'),
...
CREATE TABLE Producteurs (
    ProducteurId INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    Nom NVARCHAR(50) NOT NULL
);

SET IDENTITY_INSERT Producteurs ON

INSERT INTO Producteurs (ProducteurId, Nom) VALUES
...
CREATE TABLE Realisateurs (
    RealisateurId INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    Nom NVARCHAR(50) NOT NULL
);

SET IDENTITY_INSERT Realisateurs ON

INSERT INTO Realisateurs (RealisateurId, Nom) VALUES
    (1,'Francis Ford Coppola'),
    (2,'Claude Desrosiers'),
    (3,'Steven Soderbergh'),
    (4,'Michael Moore'),
...
CREATE TABLE SousTitres (
    SousTitreId INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    LangueSousTitre NVARCHAR(10) NOT NULL
);

SET IDENTITY_INSERT SousTitres ON
INSERT INTO SousTitres (SousTitreId, LangueSousTitre) VALUES
    (1,'Français'),
    (2,'Anglais'),
    (3,'Espagnol');
...
CREATE TABLE Supplements (
    SupplementId INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    Description NVARCHAR(50) NOT NULL
);

SET IDENTITY_INSERT Supplements ON

INSERT INTO Supplements (SupplementId, Description) VALUES
...
CREATE TABLE UtilisateursPreferences (
    UtilisateurId nvarchar(450) NOT NULL FOREIGN KEY REFERENCES AspNetUsers(UtilisateurId),
    PreferenceId INT NOT NULL FOREIGN KEY REFERENCES Preferences(PreferenceId),
	Valeur NVARCHAR(50),
	PRIMARY KEY(UtilisateurId, PreferenceId)
);
...
/*CREATE TABLE ValeursPreferences (
    NoUtilisateur nvarchar(450) NOT NULL FOREIGN KEY REFERENCES UtilisateursPreferences(UtilisateurId),
    NoPreference INT NOT NULL FOREIGN KEY REFERENCES UtilisateursPreferences(PreferenceId),
...
CREATE TABLE EmpruntsFilms (
    ExemplaireId INT NOT NULL PRIMARY KEY,
     UtilisateurId nvarchar(450) NOT NULL FOREIGN KEY REFERENCES AspNetUsers(UtilisateurId),
...
CREATE TABLE Exemplaires (
    ExemplaireId INT NOT NULL PRIMARY KEY,
    UtilisateurProprietaireId nvarchar(450) NOT NULL FOREIGN KEY REFERENCES AspNetUsers(UtilisateurId),
);
...
CREATE TABLE Films (
    ...
    AnneeSortie INT,
    Categorie INT FOREIGN KEY REFERENCES Categories(CategorieId),
    Format INT FOREIGN KEY REFERENCES Formats(FormatId),
    DateMAJ DATETIME NOT NULL,
    UtilisateurMAJId nvarchar(450) NOT NULL FOREIGN KEY REFERENCES AspNetUsers(UtilisateurId),
    Resume NVARCHAR(500),
    DureeMinutes INT,
    FilmOriginal INT,
    ...
    VersionEtendue BIT,
    RealisateurId INT FOREIGN KEY REFERENCES Realisateurs(RealisateurId),
    ProducteurId INT FOREIGN KEY REFERENCES Producteurs(ProducteurId),
...
CREATE TABLE FilmsActeurs (
    ...
    ActeurId INT NOT NULL FOREIGN KEY REFERENCES Acteurs(ActeurId),
...
CREATE TABLE FilmsLangues (
    FilmId INT NOT NULL FOREIGN KEY REFERENCES Films(FilmId),
    LangueId INT NOT NULL FOREIGN KEY REFERENCES Langues(LangueId),
	PRIMARY KEY(FilmId, LangueId)
);
...
CREATE TABLE FilmsSousTitres (
    FilmId INT NOT NULL FOREIGN KEY REFERENCES Films(FilmId),
    SousTitreId INT NOT NULL FOREIGN KEY REFERENCES SousTitres(SousTitreId),
	PRIMARY KEY(FilmId, SousTitreId)
);
...
CREATE TABLE FilmsSupplements (
    FilmId INT NOT NULL FOREIGN KEY REFERENCES Films(FilmId),
    SupplementId INT NOT NULL FOREIGN KEY REFERENCES Supplements(SupplementId),
	PRIMARY KEY(FilmId, SupplementId)
);
