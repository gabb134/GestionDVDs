...
CREATE TABLE UtilisateursPreferences (
    UtilisateurId INT NOT NULL FOREIGN KEY REFERENCES Utilisateurs(UtilisateurId),
...
CREATE TABLE Exemplaires (
    ExemplaireId INT NOT NULL PRIMARY KEY,
    UtilisateurProprietaireId INT NOT NULL FOREIGN KEY REFERENCES Utilisateurs(UtilisateurId)
);
...
CREATE TABLE Films (
    ...
    UtilisateurMAJId INT NOT NULL FOREIGN KEY REFERENCES Utilisateurs(UtilisateurId),
    Resume NVARCHAR(500),
    DureeMinutes INT,
    FilmOriginal INT,
