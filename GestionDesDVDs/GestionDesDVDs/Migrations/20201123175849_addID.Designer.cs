...
namespace GestionDesDVDs.Migrations
{
    ...
    [Migration("20201123175849_addID")]
    partial class addID
    {
            ...
            modelBuilder.Entity("GestionDesDVDs.Models.FilmsActeurs", b =>
                {
                    ...
                    b.HasKey("FilmId", "NoActeur");

                    b.HasAlternateKey("FilmId");
